...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-inko/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-inko/actions/workflows/validate.yml)

Neovim tree-sitter queries for **inko**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-inko",
...
- [ ] Changes are scoped to `inko` — do not include files for other languages
